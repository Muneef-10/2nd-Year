/* Write a program to create a class named shape. In this class we have three sub classes circle,triangle and square each class has two member functions
named draw () and erase(). Implements these functions using runtime polymorphism concepts.*/
#include <iostream>
using namespace std;
class Shape
{
